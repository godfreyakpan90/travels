...
;
!function(o,i,n){"use strict";0===o(".rex-loading").length&&o("body").prepend('<div class="rex-loading"></div>'),o("form").on("submit",(function(){this.checkValidity()&&o("body .rex-loading").show()})),o(window).on("load, pagehide",(function(){o("body .rex-loading").hide()}));var e=null;o(document).ajaxStart((function(){e=setTimeout((function(){o("body .rex-loading").show()}),1e3)})).ajaxStop((function(){clearTimeout(e),o("body .rex-loading").hide()}))}(jQuery,Drupal,drupalSettings);
...
;
!function(o){function s(o,s){return 0!==s.length&&("none"!==o.children(".row").first().css("background-image")||"none"!==s.children(".row").first().css("background-image")?o.children(".row").first().css("background-image")===s.children(".row").first().css("background-image"):o.children(".row").first().css("backgroundColor")===s.children(".row").first().css("backgroundColor"))}function a(o,s){o.hasClass("bg-image")||s.hasClass("bg-image")||"#ffffff"===o.children(".row").first().css("backgroundColor")||o.addClass("collapse-whitespace")}o.cssHooks.backgroundColor={get:function(o){var s=window.getComputedStyle(o,null).getPropertyValue("background-color");return s=-1!==s.search("transparent")?"#ffffff":function(o){var s=o.replace(/\s/g,"").match(/^rgba?\((\d+),(\d+),(\d+),?([^,\s)]+)?/i);if(s){var a=(256|s[1]).toString(16).slice(1),l=(256|s[2]).toString(16).slice(1),r=(256|s[3]).toString(16).slice(1),t="",d=(s[4]||"").trim();return""!==d&&(t=(255*d|256).toString(16).slice(1)),"00"===t||"ff"===a&&"ff"===l&&"ff"===r&&"ff"===t?"#ffffff":("#"+a+l+r+t).toLowerCase()}return o.toLowerCase()}(s)}},o(document).ready((function(){o(".block.top").length&&o(".block.top").hasClass("full-bleed")&&(o(".block.full-bleed-ready").toggleClass("full-bleed-ready full-bleed"),o("#content > .layout.col2-50-50-fw").each((function(){2===o(".block.banner.full-bleed",o(this)).length&&o(this).addClass("full-bleed")})));var l=!1,r=[];o("#content > .layout").each((function(){o(this).find(".block").length>0&&r.push(o(this))}));for(var t=0;t<r.length;t++){var d=r.length-1,e=o(r[t-1]),n=o(r[t]),c=o(r[t+1]);if(n.hasClass("col1"))for(var f=o(".layout-col > .block",n),i=0;i<f.length;i++){var h=f.length-1,b=o(f[i-1]),u=o(f[i]),C=o(f[i+1]),g=o(".block.hero-cta.top");(0===t&&1===i&&f.length>1||1===t&&0===i&&!l)&&(g.length?g.hasClass("full-width")&&g.hasClass("allow-no-bottom-margin")&&u.hasClass("full-width")&&u.toggleClass("allow-no-bottom-margin no-bottom-margin"):u.hasClass("rounded-top")?u.removeClass("rounded-top"):u.hasClass("rounded-both")&&u.removeClass("rounded-both").addClass("rounded-bottom"),l=!0),0===i&&(e.hasClass("col1")?b=o(".block:last-child",r[t-1]):(u.hasClass("rounded-both")||u.hasClass("rounded-top"))&&e.addClass("rounded-block-below")),i===h&&(t<d?c.hasClass("col1")?C=o(".block:first-child",r[t+1]):(u.hasClass("rounded-both")||u.hasClass("rounded-bottom"))&&c.addClass("rounded-block-above"):t===d&&(u.hasClass("rounded-both")?u.removeClass("rounded-both").addClass("rounded-top"):u.hasClass("rounded-bottom")&&u.removeClass("rounded-bottom"),u.hasClass("full-width")&&"#ffffff"!==u.children(".row").first().css("backgroundColor")&&u.addClass("no-bottom-margin"))),u.hasClass("full-width")&&u.hasClass("allow-no-bottom-margin")&&C.hasClass("full-width")&&u.toggleClass("allow-no-bottom-margin no-bottom-margin");var m=s(u,b),w=s(u,C);u.hasClass("no-bottom-margin")&&w&&a(u,C),u.hasClass("rounded-both")&&(m?u.removeClass("rounded-both").addClass("rounded-bottom"):w&&(u.removeClass("rounded-both").addClass("rounded-top"),a(u,C))),u.hasClass("rounded-top")&&m&&u.removeClass("rounded-top"),u.hasClass("rounded-bottom")&&w&&(u.removeClass("rounded-bottom"),a(u,C)),u.hasClass("rounded-both")?(b.addClass("rounded-block-below"),C.addClass("rounded-block-above")):u.hasClass("rounded-top")?b.addClass("rounded-block-below"):u.hasClass("rounded-bottom")&&C.addClass("rounded-block-above")}if(n.hasClass("col2-50-50-fw")&&t===d&&n.addClass("no-bottom-margin"),n.hasClass("col2-50-50-fw")){var k=o(".block:first-child",c);o(".block.banner.allow-no-bottom-margin",n).length>=2&&("none"!==k.children(".row").first().css("background-image")||"#ffffff"!==k.children(".row").first().css("background-color"))&&n.addClass("no-bottom-margin")}if(c.hasClass("col2-50-50-fw")){var v=o(".block:last-child",n);!v.hasClass("allow-no-bottom-margin")||"none"===v.children(".row").first().css("background-image")&&"#ffffff"===v.children(".row").first().css("background-color")||v.toggleClass("allow-no-bottom-margin no-bottom-margin")}}}))}(jQuery);
...
;
!function(a,t,s,e){"use strict";var i="https://www.ucalgary.ca/feeds/alerts";window.location.hostname.indexOf("staging-")>-1?i=i.replace(/live-/,"staging-"):window.location.hostname.indexOf(".docker")>-1&&(i=i.replace(/^.*:\/\/.+?\//,"/")),a.getJSON(i,(function(t){if(t.length){var i=t[0].ucws_site_alert_id,n=t[0].ucws_site_alert_timestamp,l=t[0].ucws_site_alert_message;a("header").prepend('<div id="global-alert" data-site-alert-id="'+(u=t[0]).ucws_site_alert_id+'"data-site-alert-timestamp="'+u.ucws_site_alert_timestamp+'"class="row '+u.ucws_site_alert_bgcolour+'"><div class="container"><div class="row controls"><div class="col-12"><div class="btn-toolbar"><div class="btn-group"><a id="alert-toggle" class="btn btn-rounded btn-tab" type="button"><span class="visually-hidden">Toggle Site Alert Message</span><span aria-hidden="true"><span class="ucws-icon ucws-icon-close"></span><span class="ucws-icon ucws-icon-exclamation"></span></span></a></div></div></div></div><div class="row content"><div class="col-12"><div class="alert-message"><p><span class="message">'+u.ucws_site_alert_message+'</span> <span class="link">'+u.ucws_site_alert_link+'</span></p></div><div class="alert-timestamp"><p><span class="date">'+u.ucws_site_alert_date+'</span><span class="time">'+u.ucws_site_alert_time+"</span></p></div></div></div></div></div>");var c=a("#global-alert");a(".link a",c).addClass("read-more"),a("body").addClass("site-alert");var r="ucws-alert"+i+n,o="ucws-alert-dismissed"===e.get(r),d=void 0!==s&&void 0!==s.user&&void 0!==s.user.uid&&s.user.uid>0;o||d||(a(".row.content",c).slideDown(),a(".row.controls .btn",c).removeClass("btn-tab"),"undefined"!=typeof ucwsSendAnalyticsEvent&&ucwsSendAnalyticsEvent("Site Alert","View",l,{nonInteraction:!0}),a(".row.controls .btn",c).on("click",(function(){var a=new Date;a.setTime(a.getTime()+864e5);var t="";window.location.hostname.indexOf("ucalgary.ca")>-1&&(t="ucalgary.ca"),e.set(r,"ucws-alert-dismissed",{expires:a,sameSite:"None",secure:!0,domain:t})}))),a(".row.controls .btn",c).on("click",(function(){a(".row.content",c).slideToggle(),a(this).toggleClass("btn-tab")})),a(".row.controls .btn",c).attr("data-ucws-analytics-toggle","").attr("data-ucws-analytics-category","Site Alert").attr("data-ucws-analytics-label",l).attr("data-ucws-analytics-off-class","btn-tab"),a(".row.content .link > a",c).attr("data-ucws-analytics-click","").attr("data-ucws-analytics-category","Site Alert").attr("data-ucws-analytics-label",l).attr("data-ucws-analytics-action","Link Click")}var u}))}(jQuery,Drupal,drupalSettings,window.Cookies);

;
!function(e,n){"use strict";n.behaviors.ucalgaryMenu={isInitialized:!1,attach:function(n){if(!this.isInitialized){this.isInitialized=!0;var i=e("#uc-menu"),u=e("#hamburger",i);e(".uc-menu-wrapper li > a",i).on("click",(function(n){"#"===e(this).attr("href")&&n.preventDefault()})),e(".uc-menu-wrapper li > a",i).on("focus mousedown",(function(n){if("#"===e(this).attr("href"))e(this).closest("li").hasClass("uc-active-link")&&e(this).closest("ul").is(".tabbed.level2")||a(e(this).closest("li.children"));else{let n=e(this).closest("ul").hasClass("level3")||e(this).closest("ul").hasClass("level4"),i=e(this).closest("ul.level2").hasClass("tabbed"),u=e(this).closest("li.uc-active-link:not(.uc-main-menu)").hasClass("uc-active-link"),s=e(this).closest("li.uc-active-link").hasClass("uc-active-link");l()?i&&!u&&n?a(e(this).parentsUntil(".level2.uc-submenu","li.children")):i||s||a(e(this).closest("li.children")):n?(a(e(this).parentsUntil(".level1.uc-submenu","li.children")),a(e(this).parentsUntil(".level2.uc-submenu","li.children"))):a(e(this).closest("li.children"))}return!1})),e("li.uc-back > a").on("click",(function(){return e(this).closest("ul").removeClass("uc-active-link-submenu").closest("li.children").removeClass("uc-active-link").closest("ul").removeClass("uc-active-path").not(".level1").addClass("uc-active-link-submenu").closest("li.children").removeClass("uc-active-path").addClass("uc-active-link").parents("ul, li").addClass("uc-active-path"),e("ul.level1.uc-menu",i).addClass("uc-off-current-path"),!1})),u.on("click",(function(){l()?(e(".uc-menu-wrapper",i).addClass("uc-menu-toggle"),e(".uc-menu-wrapper, ul.level2.uc-submenu",i).on("transitionend webkitTransitionEnd oTransitionEnd",(function(n){n.target===n.currentTarget&&(e(".uc-menu-wrapper",i).removeClass("uc-menu-toggle"),t(),e("ul.level1.uc-menu",i).removeClass("uc-off-current-path"),u.removeClass("uc-menu-open uc-mobile-menu-open uc-desktop-menu-open"),e(".uc-menu-wrapper, ul.level2.uc-submenu",i).off("transitionend webkitTransitionEnd oTransitionEnd"))})),u.removeClass("uc-mobile-menu-open"),e("ul.level2.uc-submenu",i).height(0)):(e(".uc-menu-wrapper",i).addClass("uc-menu-toggle"),e(".uc-menu-wrapper, ul.level2.uc-submenu",i).on("transitionend webkitTransitionEnd oTransitionEnd",(function(n){n.target===n.currentTarget&&(e(".uc-menu-wrapper",i).removeClass("uc-menu-toggle"),e(".uc-menu-wrapper, ul.level2.uc-submenu",i).off("transitionend webkitTransitionEnd oTransitionEnd"))})),u.addClass("uc-menu-open uc-mobile-menu-open uc-desktop-menu-open"))})),e(document).on("click focusin",(function(e){if(l()){var n=i;n.is(e.target)||0!==n.has(e.target).length||u.trigger("click")}})),e(window).on("resize",(function(n){s(e('ul.level2.uc-submenu[class*="uc-active-"]',i))})),e("li.menu-block-item",i).not(":last-child").each((function(){e(this).appendTo(e(this).parent())})),e("li.current > a",i).last().closest("ul").addClass("uc-current-link-submenu").parent("li").addClass("uc-current-link").parents("ul, li").addClass("uc-current-path")}function s(n){if(n.length){var i=0;if(n.hasClass("tabbed")){var u=e("> li:not(.menu-block-item)",n);u.each((function(n){if(n===u.length-1){var s=e(this).outerHeight(!0)+e(this).position().top;s>i&&(i=s)}var l=e("ul.level3.uc-submenu",this),t=l.outerHeight(!0);l.position()&&(t+=parseInt(l.css("top"),10)),t>i&&(i=t)}))}else i=e("div.uc-sublinks",n).outerHeight(!0);n.height(i)}}function l(){return u.hasClass("uc-menu-open")}function t(){e(".uc-active-path",i).removeClass("uc-active-path"),e(".uc-active-link",i).removeClass("uc-active-link"),e(".uc-active-link-submenu",i).removeClass("uc-active-link-submenu")}function c(n){l()||u.trigger("click"),t(),n.addClass("uc-active-link").children("ul").addClass("uc-active-link-submenu"),n.parents("ul, li.children").addClass("uc-active-path"),s(e("ul.level2.uc-submenu",n))}function a(n){n.closest("ul").hasClass("uc-active-link-submenu")||n.siblings().not(".uc-main-menu").hasClass("uc-active-link")?c(n):e('li[class*="uc-active"].uc-main-menu',i).length?n.hasClass("uc-main-menu")&&(n.hasClass("uc-active-path")||n.hasClass("uc-active-link"))?l()&&u.trigger("click"):(e("ul.level2.uc-submenu",i).on("transitionend webkitTransitionEnd oTransitionEnd",(function(u){u.target===u.currentTarget&&(c(n),e("ul.level2.uc-submenu",i).off("transitionend webkitTransitionEnd oTransitionEnd"))})),function(n){n.removeClass("uc-active-link").parents("ul, li").removeClass("uc-active-path"),e(".level2.uc-submenu",i).height(0)}(e('li[class*="uc-active"].uc-main-menu',i))):c(n),e("ul.level1.uc-menu",i).addClass("uc-off-current-path")}}}}(jQuery,Drupal);
